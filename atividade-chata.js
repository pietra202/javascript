...
const diferenca = dataAnual.getTime() - dataNasc.getTime();
...
const diferencaAnos = dataAnual.getFullYear() - dataNasc.getFullYear();
console.log(`diferença em anos: ${diferencaAnos}`);

if (
  dataAnual.getMonth() < dataNasc.getMonth() ||
  (dataAnual.getMonth() === dataNasc.getMonth() &&
    dataAnual.getMonth() < dataNasc.getDate())
) {
  console.log(`ainda não fez aniversario`);
...
var texto4 = "ola, meu nome é Pietra";
console.log(`tamanho do texto: ${texto4.length}
caracteres!`);

var texto5 = "ola, meu nome é \"Pietra\"!";
console.log(texto5);
var texto6 = "quebravde linha \ noutra linha";
console.log(texto6);
